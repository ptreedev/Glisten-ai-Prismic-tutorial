...
const Bento = ({ slice }: BentoProps): JSX.Element => {
  return (
    ...
    >
      ...
      />
      <div className="ma-w-md mx-auto mt-6 text-balance text-center text-slate-300">
        <PrismicRichText field={slice.primary.body} />
      </div>
      <div className="mt-16 grid max-w-4xl grid-rows-[auto_auto_auto] gap-8 md:grid-cols-3 md:gap-8">
        {slice.primary.bentobox.map((item) => (
          <div
            className={clsx(
              "glass-container row-span-4 grid grid-rows-subgrid gap-4 rounded-lg bg-gradient-to-b from-gray-900 to-gray-950 p-4",
